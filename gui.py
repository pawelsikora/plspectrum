...
class GUI:
	...
	self.label_about.set_margin_left(300)
	self.label_authors = Gtk.Label('Authors')
        self.label_authors.set_markup("<span font='26'><b>Authors</b></span>")
	self.label_authors.set_margin_left(300)
	self.label_authors_text = Gtk.Label(justify = Gtk.Justification.CENTER)
	self.label_authors_text.set_margin_left(290)
        self.label_authors_text.set_markup("<span font='12'> <b>Piotr Ruszala</b>, '204185@student.pwr.edu.pl', (Physics)           <b>Pawel Sikora</b> 'sikor6@gmail.com', (Interface, pyGtk) </span>")
	self.label_about_text = Gtk.Label(justify = Gtk.Justification.CENTER)
	self.label_about_text.set_margin_left(300)
...
All with pyGTK and using GTK3+.</span>")
	...
	self.logo_about = Gtk.Image.new_from_file('logo_about.png')
        ...
        self.frame_logo.set_margin_left(300)
        ...
        self.box_page_about.attach_next_to(self.label_authors, self.label_about_text, Gtk.PositionType.BOTTOM, 1, 1)
        self.box_page_about.attach_next_to(self.label_authors_text, self.label_authors, Gtk.PositionType.BOTTOM, 1, 1)
        ...
        self.label_energy_levels = Gtk.Label("Nb of params")
        ...
        self.label_param_a0.set_halign(1)
        self.label_param_g0.set_halign(1)
        self.label_param_eg.set_halign(1)
        self.label_param_ef.set_halign(1)
        self.label_param_en.set_halign(1)
        self.label_param_emin.set_halign(1)
        self.label_param_emax.set_halign(1)
        self.label_param_edn.set_halign(1)
        self.label_param_ecmin.set_halign(1)
        self.label_param_ecmax.set_halign(1)
        self.label_param_ecdn.set_halign(1)
        self.label_param_evmin.set_halign(1)
        self.label_param_evmax.set_halign(1)
        self.label_param_evdn.set_halign(1)
        self.label_param_cp.set_halign(1)
        self.label_param_cb.set_halign(1)
        self.label_param_hh.set_halign(1)
        self.label_param_lh.set_halign(1)
        self.label_param_wsk.set_halign(1)
        self.label_param_T.set_halign(1)
        self.label_param_gamma.set_halign(1)
        self.label_param_step_func_gamma.set_halign(1)
        self.label_energy_levels.set_halign(1)
        self.label_number_of_energy_levels.set_halign(0.5)
        self.label_number_of_cp.set_halign(0.5)
        self.label_number_of_cb.set_halign(0.5)
        self.label_number_of_hh.set_halign(0.5)
        self.label_number_of_lh.set_halign(0.5)
        self.label_number_of_wsk.set_halign(0.5)
        self.label_param_mee.set_halign(1)
        self.label_param_mehh.set_halign(1)
        self.label_param_melh.set_halign(1)
        self.label_emass_pick.set_halign(0.5)
        ...
        self.entry_param_emin.set_width_chars(1)
        self.entry_param_emax.set_width_chars(1)
        self.entry_param_edn.set_width_chars(1)

        self.entry_param_ecmin = Gtk.Entry()
        self.entry_param_ecmin.set_width_chars(6)
        self.entry_param_ecmax = Gtk.Entry()
        self.entry_param_ecmax.set_width_chars(6)
        self.entry_param_ecdn = Gtk.Entry()
        self.entry_param_ecdn.set_width_chars(6)

        self.entry_param_evmin = Gtk.Entry()
        self.entry_param_evmax = Gtk.Entry()
        self.entry_param_evdn = Gtk.Entry()
        self.entry_param_evmin.set_width_chars(6)
        self.entry_param_evmax.set_width_chars(6)
        self.entry_param_evdn.set_width_chars(6)
        ...
        list_store.append([5, "Entry,emin", self.entry_param_emin, "Emin [eV]"])
        list_store.append([6, "Entry,emax", self.entry_param_emax, "Emax [eV]"])
        list_store.append([7, "Entry,edn", self.entry_param_edn, "Estep [eV]"])
        list_store.append([8, "Entry,ecmin", self.entry_param_ecmin, "Ec min [eV]"])
        list_store.append([9, "Entry,ecmax", self.entry_param_ecmax, "Ec max [eV]"])
        list_store.append([10, "Entry,ecdn", self.entry_param_ecdn, "Ec step [eV]"])
        list_store.append([11, "Entry,evmin", self.entry_param_evmin, "Ev min [eV]"])
        list_store.append([12, "Entry,evmax", self.entry_param_evmax, "Ev max [eV]"])
        list_store.append([13, "Entry,evdn", self.entry_param_evdn, "Ev step [eV]"])
        ...
        list_store.append([20, "Entry,gamma", self.entry_param_gamma, "Gamma Peak [eV]"])
        list_store.append([21, "Entry,step_func_gamma", self.entry_param_step_func_gamma, "Gamma step [eV]"])
	...
	self.grid_emass.set_margin_left(30)
	self.grid_emass.set_margin_top(40)
	self.grid_emass.set_margin_bottom(10)
	self.grid_energy.set_margin_top(10)
        self.grid_emass.set_row_spacing(20)
        self.grid_emass.set_column_spacing(30)
...
#        self.grid_emass.attach(self.compound_combobox, 2, 1, 1, 1)
	...
	self.grid_simulation_params.set_margin_right(10)
        ...
        self.grid_simulation_params.attach_next_to(self.label_param_step_func_gamma, self.entry_param_gamma, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_step_func_gamma, self.label_param_step_func_gamma, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.label_param_T, self.label_param_gamma, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_T, self.label_param_T, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.label_param_a0, self.label_param_step_func_gamma, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_a0,self.label_param_a0, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.label_param_g0, self.entry_param_a0, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_g0,self.label_param_g0, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.label_param_emin, self.label_param_T, Gtk.PositionType.BOTTOM, 1, 1)
        ...
        self.grid_simulation_params.attach_next_to(self.entry_param_emin,  self.label_param_emin, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.label_param_ecmin, self.entry_param_emin, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_ecmin, self.label_param_ecmin, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.label_param_evmin, self.entry_param_ecmin, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_evmin, self.label_param_evmin, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_emax,  self.entry_param_emin, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid_simulation_params.attach_next_to(self.label_param_ecmax, self.entry_param_emax, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_ecmax, self.label_param_ecmax, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.label_param_evmax, self.entry_param_ecmax, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_evmax, self.label_param_evmax, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_edn,   self.entry_param_emax, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid_simulation_params.attach_next_to(self.label_param_ecdn,  self.entry_param_edn, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_ecdn,  self.label_param_ecdn, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.label_param_evdn,  self.entry_param_ecdn, Gtk.PositionType.RIGHT, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_evdn,  self.label_param_evdn, Gtk.PositionType.RIGHT, 1, 1)

        # frames
        self.grid_page_main.attach(self.frame_simulation_params, 0, 0, 2, 5)
        self.grid_page_main.attach(self.frame_energy, 2, 0, 5, 8)
        self.grid_page_main.attach(self.frame_emass, 0, 5, 2, 3)

...
#        self.grid_emass.attach(self.compound_combobox, 2, 1, 1, 1)
        ...
        self.grid.attach_next_to(self.label_param_step_func_gamma, self.label_param_gamma, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid.attach_next_to(self.label_param_T, self.label_param_step_func_gamma, Gtk.PositionType.BOTTOM, 1, 1)
        ...
        self.grid.attach_next_to(self.label_param_emin, self.label_param_g0, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid.attach_next_to(self.label_param_emax, self.label_param_emin, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid.attach_next_to(self.label_param_edn, self.label_param_emax, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid.attach(self.entry_param_gamma, 1, 2, 1, 1)
        self.grid.attach_next_to(self.entry_param_step_func_gamma, self.entry_param_gamma, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid.attach_next_to(self.entry_param_T, self.entry_param_step_func_gamma, Gtk.PositionType.BOTTOM, 1, 1)
        ...
        self.grid.attach_next_to(self.entry_param_emin, self.entry_param_g0, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid.attach_next_to(self.entry_param_emax, self.entry_param_emin, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid.attach_next_to(self.entry_param_edn,  self.entry_param_emax, Gtk.PositionType.BOTTOM, 1, 1)

        # frames
        self.grid.attach(self.frame_energy, 2, 1, 5, 7)
        self.grid.attach(self.frame_emass, 2, 8, 5, 4)

...
All with pyGTK and using GTK3+.</span>")
	...
	self.grid_energy.set_margin_top(20)
        self.grid_energy.set_row_spacing(20)
        self.grid_energy.set_column_spacing(20)
	...
	self.grid_emass.set_margin_left(200)
	self.grid_emass.set_margin_top(20)
	self.grid_emass.set_margin_top(20)
...
#        self.grid_emass.attach(self.compound_combobox, 2, 1, 1, 1)
	...
	self.grid_simulation_params.set_margin_bottom(20)

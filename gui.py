...
class GUI:
    ...
    def __init__(self):
        ...
        self.grid_page_main.set_column_spacing(5)
...
#	self.label_about.set_xalign(0.5)
...
#	self.label_authors.set_xalign(0.5)
...
#        self.grid_emass.attach(self.compound_combobox, 2, 1, 1, 1)
	...
	self.grid_simulation_params.set_margin_right(10)
        ...
        self.grid_simulation_params.attach_next_to(self.label_param_g0, self.label_param_T, Gtk.PositionType.BOTTOM, 1, 1)
        ...
        self.grid_simulation_params.attach_next_to(self.label_param_evmin, self.label_param_edn, Gtk.PositionType.BOTTOM, 1, 1)
        ...
        self.grid_simulation_params.attach_next_to(self.label_param_evmax, self.label_param_evmin, Gtk.PositionType.BOTTOM, 1, 1)
        ...
        self.grid_simulation_params.attach_next_to(self.label_param_evdn,  self.label_param_evmax, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid_simulation_params.attach_next_to(self.entry_param_evdn,  self.label_param_evdn, Gtk.PositionType.RIGHT, 1, 1)

        # frames
        self.grid_page_main.attach(self.frame_simulation_params, 0, 0, 1, 8)
        self.grid_page_main.attach(self.frame_energy, 1, 0, 1, 8)

...
All with pyGTK and using GTK3+.</span>")
	...
	self.logo_about = Gtk.Image.new_from_file('logo_about.png')
        ...
        list_store.append([18, "Entry,emin", self.entry_param_emax, "E min [eV]"])
        list_store.append([19, "Entry,ecmin", self.entry_param_emax, "Ec min [eV]"])
        list_store.append([20, "Entry,ecmax", self.entry_param_emax, "Ec max [eV]"])
        list_store.append([21, "Entry,ecdn", self.entry_param_emax, "Ec step [eV]"])
        list_store.append([22, "Entry,evmin", self.entry_param_emax, "Ev min [eV]"])
        list_store.append([23, "Entry,evmax", self.entry_param_emax, "Ev max [eV]"])
        list_store.append([24, "Entry,evdn", self.entry_param_emax, "Ev step [eV]"])

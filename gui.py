...
#        self.grid_emass.attach(self.compound_combobox, 2, 1, 1, 1)
        ...
        self.grid_simulation_params.set_row_spacing(10)
        self.grid_simulation_params.set_column_spacing(30)
        self.frame_simulation_params.add(self.grid_simulation_params)

        self.grid_simulation_params.attach(self.label_param_gamma, 0, 2, 1, 1)
        ...
        self.grid_simulation_params.attach(self.entry_param_gamma, 1, 2, 1, 1)

...
class Calculator:
    ...
    def calculate_all_parameters(self):
        ...
        self.calculate_dosCB(self.params.g0, self.params.me, self.params.Ec,
                             self.params.CB)

        self.calculate_dosHH(self.params.g0, self.params.HH, self.params.mehh,
                             self.params.Ev)

        self.calculate_dosHH_probability(self.params.HH, self.params.Ev,
                                         self.params.g0, self.params.mehh)

        self.calculate_masy_r(self.params.En, self.params.wsk, self.urehh,
                              self.urelh)

        self.calculate_dos(self.params.En, self.params.E, self.params.g0,
                           self.params.CP, self.params.step_func_gamma)

        self.calculate_dos2(self.params.En, self.params.E, self.params.g0,
                            self.params.CP, self.params.step_func_gamma)

        self.calculate_hevisajd(self.params.En, self.params.E, self.params.g0,
                                self.masy_r)

        self.calculate_pik(self.params.En, self.params.A0, self.params.E,
                           self.params.gamma)

        self.calculate_Normal(self.params.En, self.params.E, self.params.A0,
                              self.params.gamma)

        self.calculate_pik_mieszany(self.params.En, self.params.E,
                                    self.params.A0, self.params.gamma)

        self.calculate_delty(self.params.En, self.params.E, self.params.A0)

        self.calculate_dosVB(self.params.En, self.dosHH, self.dosLH)

        self.calculate_jdos(self.params.En, self.params.E, self.params.g0,
                            self.masy_r, self.params.step_func_gamma)

        self.calculate_jdos2(self.params.En, self.params.E, self.params.g0,
                             self.masy_r, self.params.step_func_gamma)

        self.calculate_abs1(self.params.En, self.params.E, self.params.g0,
                            self.params.CP, self.masy_r,
                            self.params.step_func_gamma)

        self.calculate_abs2(self.params.En, self.params.E, self.params.g0,
                            self.params.CP, self.masy_r,
                            self.params.step_func_gamma)

        self.calculate_abs3(self.params.En, self.params.E, self.params.g0,
                            self.params.CP, self.masy_r)
